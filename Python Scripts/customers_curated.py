...
accelerometer_landing_node1691851252736 = glueContext.create_dynamic_frame.from_options(
    ...
    transformation_ctx="accelerometer_landing_node1691851252736",
)
...
Join_node1691851443493 = Join.apply(
    frame1=accelerometer_landing_node1691851252736,
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://udacity-mathieu/customer_curated/",
        "partitionKeys": [],
    },
